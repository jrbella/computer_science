...
def greet():
  ...
  print("We'll help you find the shortest route betweent he following Vancouver landmarks:\n" + landmark_string)
...
def get_start():
  ...
  if landmark_choices[start_point_letter]:
    ...
    # this returns our starting vertex
    return start_point
  else:
...
def get_end():
  ...
  if landmark_choices[end_point_letter]:
    ...
    # this returns our ending vetex (or targetd vertex)
    return end_point
  else:
    print("Sorry, that's not a landmark we have data on. Let's try this again...")
    get_end()
...
def get_active_stations():
  ...
  for station_under_construction in stations_under_construction:
    for current_station, neighboring_stations in station_under_construction.items():
      if current_station not in station_under_construction:
